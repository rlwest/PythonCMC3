...
def start_task(memories):
    memories['working_memory']['focus_buffer']['task'] = 'bread1'
...
ProceduralProductions.append({
    ...
    'utility': 10,
    'action': start_task,
    'report': "Start task, request motor system move bread****************************************"
})
...
def delayed_bread1(memories):
    ...
    memories['environment_memory']['bread1']['location'] = 'on_plate'
...
ps.run_cycles(memories, AllProductionSystems, DelayResetValues, cycles=50, millisecpercycle=10)
